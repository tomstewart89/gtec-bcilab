...
- ovasCConfigurationGTecGUSBampLinux.h
- ovasCConfigurationGTecGUSBampLinux.cpp
- ovasCDriverGTecGUSBampLinux.h
- ovasCDriverGTecGUSBampLinux.cpp
You can put these files here in your local repository:
     [openvibe-repository]/contrib/plugins/server-drivers/[my-device]/src/

The glade interface:
- interface-GTecGUSBampLinux.glade
