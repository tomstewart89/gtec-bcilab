...
namespace OpenViBE
{
	namespace Kernel
	{
		class CLogListenerFileBuffered : public OpenViBE::Kernel::ILogListener
		{
		public:

			CLogListenerFileBuffered(const OpenViBE::Kernel::IKernelContext& rKernelContext, const CString& sApplicationName, const OpenViBE::CString& sLogFilename);
